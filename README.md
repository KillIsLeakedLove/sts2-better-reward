...
- `ExtraRewardOptionsPatch` 定位并补丁 `MegaCrit.Sts2.Core.Hooks.Hook.ModifyRewards`，当房间类型为 `Elite` 或 `Boss` 时向奖励列表追加 1 个随机奖励选项。
- 随机奖励目前包括 `RelicReward`、`GoldReward(100)`、自定义卡牌升级奖励、自定义卡牌移除奖励和自定义生命上限奖励。
